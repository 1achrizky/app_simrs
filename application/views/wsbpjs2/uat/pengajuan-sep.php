        ...
        <div class="col-md-6">
          <div class="box box-success" style="border-top-color: #117d70;">
            ...
            <div class="box-body">
              ...
              <form action="<?=base_url('wsbpjs2/pengajuanSep/');?>" name="frmPengajuanSep" method="POST">
                <table class="table table-borderred table-striped">
                  ...
                  <tr>
                    <td colspan="2">
                      <!-- <input type="submit"> -->
                      <!-- <button id="btn_ok" name="action" value="pengajuan" class="btn btn-success">PENGAJUAN</button>
                      <button id="btn_aproval" name="action" value="aproval" class="btn btn-info">APROVAL</button> -->
                      <input type="submit" id="btn_ok" name="action" value="PENGAJUAN" class="btn btn-success">
                      <input type="submit" id="btn_aproval" name="action" value="APROVAL" class="btn btn-info">
                    </td>
                  </tr>
                </table>
