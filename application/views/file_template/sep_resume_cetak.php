		...
		<div id="kertas_resume" class="row ft_normal" style="font-size: 10pt;">
			...
			<table name="" border=1>
				...
				<tr>
					...
					<td class="col-xs-4"><?=$lokasi_ket;?> / <?=$nourut;?></td>
				</tr>
				<tr>
		...
		<div class="kertas_sep" style="font-size: 7pt;">
			<div style="overflow: hidden; margin-bottom: 10px;">
				...
				<div class="col-xs-5" style="height: 30px; line-height: 0.8;">
					<span style="font-family:'Free 3 of 9'; font-size: 26pt;" class="unbold">*<?=strtoupper($noSep);?>*</span>
				</div>
			...
			<div class="col-xs-12">
				<table name="sep1" class="ft_normal" border=0 width="100%">
					<tr>
						<td>No.SEP</td>
						<td style="font-size: 14pt;">: <?=strtoupper($noSep);?></td>
						<td>Prolanis PRB</td>
