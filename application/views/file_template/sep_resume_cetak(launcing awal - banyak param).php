	...
	<div class="container row font_cetak" name="main">
		...
		<div id="kertas_resume" class="row ft_normal" style="font-size: 10pt;">
			<table name="" border=1>
				<tr>
					...
					<td class="col-xs-5" style="text-align: center;">
						<span style="font-family:'Free 3 of 9'; font-size: 28pt;" class="unbold">*<?=$billing;?>*</span>
					</td>
				</tr>
			</table>
			...
			<table name="" border=1>
				<tr>
					...
					<td class="col-xs-4 uppercase"><?=$nama;?></td>
					<td class="col-xs-3">Nomor Rekam Medis</td>
					<td class="col-xs-3 text_center"><span class="bold" style="font-size: 18pt;"><?=$norm;?></span></td>
				</tr>
				<tr>
					<td class="col-xs-2">Tgl.Lahir / JK</td>
					<td class="col-xs-4"><?=$tglLahir;?> / <?=$sex;?></td>
					<td class="col-xs-3">Tgl.Masuk</td>
					<td class="col-xs-3"><?=$tglSep;?></td>
				</tr>
				<tr>
					<td class="col-xs-2">Umur</td>
					<td class="col-xs-4"><?=$umurSaatPelayanan;?></td>
					<td class="col-xs-3">Tgl.Keluar</td>
					<td class="col-xs-3"><span><?=$tglSep;?></span></td>
				</tr>
				<tr>
					<td class="col-xs-2" rowspan="2">Alamat</td>
					<td class="col-xs-4" rowspan="2"><?=$alamat;?></td>
					<td class="col-xs-3">Ruang Rawat Terakhir</td>
					<td class="col-xs-3"> - </td>
				</tr>
				<tr>
					<td class="col-xs-3">Penanggung</td>
					<td class="col-xs-3">BPJS</td>
				</tr>
			</table>
			...
			<div name="part_5" class="border" style="overflow:hidden;">
				<span class="col-xs-4">Pengobatan dilanjutkan :</span>
				<span class="col-xs-4">
					[&emsp;] Poliklinik RS. Citra Medika <br>
					[&emsp;] Rumah Sakit Lain <br>
					[&emsp;] Puskesmas
				</span>
				<span class="col-xs-4">
					[&emsp;] Dokter Luar<br>
		...
		<div class="kertas_sep" style="font-size: 8pt;">
			<div style="overflow: hidden; margin-bottom: 10px;">
				...
				<div class="col-xs-4 ft_title" style="padding: 0px;">
