		...
		<div class="row">
			<div class="col-xs-12">
				<table class="tbl_px" border=0 style="width:100%;" >
					<tr>
						<td>Tanggal Bukti : </td>
						<td><span name="tgl_bukti"><?=$v['NoBill'];?></span></td>
					</tr>
					<tr>
						<td>No.Bukti : </td>
						<td><span name="nobukti"><?=$v['NoBill'];?></span></td>
					</tr>
					<tr>
						<td>Type :</td>
						<td><span name="type"><?=$v['Nama'];?></span></td>
					</tr>
					<tr>
						<td>Type Vendor :</td>
						<td><span name="type_vendor"><?=$v['Nama'];?></span></td>
					</tr>
					<tr>
						<td>Vendor :</td>
						<td><span name="vendor"><?=$v['Nama'];?></span></td>
					</tr>
					<tr>
						<td>Jumlah Dikoreksi :</td>
						<td><span name="jumlah_dikoreksi"><?=$v['Nama'];?></span></td>				
					</tr>
					<tr>
						<td>Keterangan :</td>
