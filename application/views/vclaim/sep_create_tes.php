...
<div class="container bold">
	...
	<div class="row">
		<div class="col-xs-6">
			...
			<table name="tblDataRm">
				<tr>
					<td>Poli Tujuan</td>
					<td><input type="text" name="poli_tujuan" class="form-control input-sm" required></td>
				</tr>
				<tr>
					<td>PPK Rujukan</td>
					<td><input type="text" name="ppkRujukan" class="form-control input-sm" required></td>
				</tr>
				<tr>
					<td>Tgl Rujukan</td>
					<td><input type="text" name="tglRujukan" class="form-control input-sm" required></td>
				</tr>

				<tr>
					<td>No.Rujukan</td>
					<td><input type="text" name="noRujukan" class="form-control input-sm" required></td>
				</tr>
				<tr>
					<td>Tgl Sep</td>
					<td><input type="text" name="tglSep" class="form-control input-sm" required></td>
				</tr>
				<tr>
					<td>NoMR</td>
					<td><input type="text" name="noMR" class="form-control input-sm" required></td>
				</tr>

				<tr>
					<td>NoKartu</td>
					<td><input type="text" name="noKartu" class="form-control input-sm" required></td>
				</tr>
		...
		<div class="col-xs-6">
			...
			<table name="tbl_bpjs">
				<tr>
					...
					<td><input type="text" name="jnsPelayanan" class="form-control input-sm" required></td>
				</tr>
				<tr>
					<td>Kelas Rawat</td>
					<td><input type="text" name="klsRawat" class="form-control input-sm" required></td>
				</tr>

				<tr>
					<td>Diagnosa Awal</td>
					<td><input type="text" name="diagAwal" class="form-control input-sm" required></td>
				</tr>
				<tr>
					<td>No.Telp</td>
					<td><input type="text" name="noTelp" class="form-control input-sm" value="123456789" required></td>
				</tr>
				<tr>
					<td>Catatan</td>
		...
		<div style="clear:left; padding-top:10px;">
			<button class="btn btn-primary div_center" name="btn_sep_create_self" style="width:500px; font-size: 20pt; display:block;"> Buat SEP </button>
		</div>
	...
	$(function(event){
		...
		$('button[name=btn_sep_create_self]').click(function(){
		 	//alert('oke sep');
		 	//======   ws1   ============
   ...
   //      };
		...
		$('button[name=btn_sep_hapus]').click(function(){
			...
			$.ajax({
				async: false,
				url:"<?=base_url();?>ajaxreq/sep_hapus_bpjs",
				type:"GET",
				data: { 
					//_method	: 'delete',
					nosep: $('input[name=sep_cari]').val(),
