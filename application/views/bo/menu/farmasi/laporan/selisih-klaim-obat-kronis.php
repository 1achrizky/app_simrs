...
a{
  ...
  <div class="content-wrapper">
    <section class="content-header" style="height:70px; display:none;">
      <h3 class="bold" style="text-align:center;">Selisih Klaim Obat Kronis BPJS</h3>
    </section>
    <!-- Main content -->
      ...
      <div class="row" style="display:none;">
        <div class="col-md-12" style="margin-bottom:10px;">
          <div class="form-inline">
            <div class="outer-container">
                <form action="<?=base_url()?>farmasi/upload_selisih_obat_kronis_bpjs" method="POST" name="frmExcelImport" id="frmExcelImport" enctype="multipart/form-data">
        ...
        <div class="col-md-12">
          <div class="form-inline">
            ...
            <button type="button" class="btn btn-success btn-flat" id="btn_ld_upload">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="box box-success" style="border-top-color: #117d70;">
            <h3 class="bold" style="text-align:center;">Daftar Selisih Klaim Obat Kronis BPJS</h3>
