...
class My_excel extends PHPExcel {
     ...
     * <pre>
     * $this->my_excel->set_column(array('name', 'address', 'email'));
     * </pre>
     * 
     * @access public
     * @param array $column
     ...
     * <pre>
     * $this->my_excel->set_header(array('Name', 'Address', 'Email'));
     * </pre>
     * Jika ingin tulisannya tidak dalam bentuk bold
     * <pre>
     * $this->my_excel->set_header(array('...'), FALSE);
     * </pre>
     * 
     * @access public
     * @param array $header
     ...
     * <pre>
     * $this->my_excel->set_width(array(25, 30, 15));
     * </pre>     * 
     * 
     * @access public
     * @param array $width
